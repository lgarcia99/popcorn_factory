...
class CatalogActivity : AppCompatActivity() {
    ...
    class PeliculaAdapter: BaseAdapter {
        ...
        override fun getCount(): Int {
            return peliculas.size//To change body of created functions use File | Settings | File Templates.
        }

        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            var pelicula = peliculas[position]//To change body of created functions use File | Settings | File Templates.
            var inflator = context!!.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
            var vista = inflator.inflate(R.layout.celda_pelicula, null)
            ...
            vista.image_movie_cell.setOnClickListener{
                ...
                intent.putExtra("sinopsis", pelicula.sinposis)
